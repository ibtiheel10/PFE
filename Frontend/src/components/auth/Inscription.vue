          ...
          <form>
            ...
            <template v-else>
              ...
              <div style="display: flex; gap: 10px; width: 100%; margin-top: 12px;">
                <div style="flex: 1;">
                  <label style="margin-top:0;">Ville (Optionnel)</label>
                  <input type="text" v-model="ville" class="form-control" placeholder="Tunis, Sfax..." />
                </div>
                <div style="flex: 1;">
                  <label style="margin-top:0;">Taille de l'entreprise</label>
                  <select v-model="taille" class="form-control">
