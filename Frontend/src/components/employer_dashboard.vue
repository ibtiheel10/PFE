                ...
                <div class="dashboard-grid">
                    ...
                    <div class="grid-col-right">
                        ...
                        <div class="promo-card">
                            <h3>Prêt pour une nouvelle campagne ?</h3>
                            <p>Utilisez notre IA pour générer un QCM sur mesure en quelques secondes.</p>
                            <button class="ai-btn" @click="generateQCM">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                                Générer un QCM
                            </button>
                            <div class="bulb-decoration">
                                <svg width="120" height="120" viewBox="0 0 24 24" fill="rgba(255,255,255,0.1)" stroke="none"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2v1"/><path d="M12 7a5 5 0 1 0-4 4.5V14a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-2.5A5 5 0 1 0 12 7z"/></svg>
                            </div>
                        </div>
                    </div>
                </div>
...
const navItems = [
    ...
    { name: 'Créer QCM', icon: h('svg', { xmlns:"http://www.w3.org/2000/svg", width:"15", height:"15", viewBox:"0 0 24 24", fill:"none", stroke:"currentColor", strokeWidth:"1.5", strokeLinecap:"round", strokeLinejoin:"round" }, [h('path',{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"})]) },
];
