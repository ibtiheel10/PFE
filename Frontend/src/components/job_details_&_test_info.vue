    ...
    <header class="top-nav">
      <div class="nav-content">
        ...
        <nav class="main-nav">
          ...
          <a href="#" class="nav-link">Mes Tests</a>
    ...
    <main class="main-body container">
      ...
      <section class="job-header-card" v-if="job">
        ...
        <div class="header-actions">
           <button class="btn-secondary" @click="toggleSave" :class="{ 'saved': isSaved }">
             <svg width="16" height="16" viewBox="0 0 24 24" :fill="isSaved ? 'currentColor' : 'none'" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>
             {{ isSaved ? 'Sauvegardé' : 'Sauvegarder' }}
           </button>
           <button class="btn-primary" @click="applyToJob">Postuler</button>
        </div>
      </section>
